          ...
          Container(
            ...
            child: ListView(
              ...
              children: [
                ...
                _filterChip('Received', 'received', repairProv),
                _filterChip('In Progress', 'in_progress', repairProv),
                _filterChip('Ready', 'ready', repairProv),
                _filterChip('Delivered', 'delivered', repairProv),
              ],
            ),
          ),
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 10),
                TextField(controller: phoneCtrl, keyboardType: TextInputType.phone, style: const TextStyle(color: AppTheme.lightText), decoration: const InputDecoration(labelText: 'Customer Phone')),
                const SizedBox(height: 10),
                ...
                const SizedBox(height: 10),
                TextField(controller: issueCtrl, style: const TextStyle(color: AppTheme.lightText), decoration: const InputDecoration(labelText: 'Fault / Issue Description *')),
                const SizedBox(height: 10),
                TextField(controller: costCtrl, keyboardType: const TextInputType.numberWithOptions(decimal: true), style: const TextStyle(color: AppTheme.lightText), decoration: const InputDecoration(labelText: 'Estimated Repair Cost')),
              ],
            ),
          ),
        ),
