...
class PdfInvoiceService {
  /// Generate PDF and open print/share dialog (works on Web, Android, iOS, Windows, macOS)
  static Future<String> generateAndSaveInvoice({
    ...
    try {
          ...
          build: (pw.Context context) {
            return pw.Column(
              ...
              children: [
                  ...
                  children: [
                    ...
                    pw.Column(
                      ...
                      children: [
                        ...
                        pw.Text('Type: ${sale.saleType.toUpperCase()}',
                            style: pw.TextStyle(
                                fontSize: 10,
                                fontWeight: pw.FontWeight.bold,
                ...
                pw.Row(
                  ...
                  children: [
                    pw.SizedBox(
                      ...
                      child: pw.Column(
                        children: [
                          _pdfSummaryRow('Subtotal:',
                              '${settings.currency} ${sale.subtotal.toStringAsFixed(2)}'),
                          if (sale.discount > 0)
                            _pdfSummaryRow('Discount:',
                                '- ${settings.currency} ${sale.discount.toStringAsFixed(2)}'),
                          pw.Divider(thickness: 1),
                          _pdfSummaryRow('Total Amount:',
                ...
                pw.Center(
                  child: pw.Text(settings.receiptFooter,
                      style: const pw.TextStyle(
      ...
      // Use printing package to share/print/save — works on ALL platforms including Web
      await Printing.sharePdf(
        bytes: await pdf.save(),
        filename: 'Invoice_${sale.billNo}.pdf',
      );

      return 'Invoice_${sale.billNo}.pdf';
    } catch (e) {
      debugPrint('PDF Invoice error: $e');
      return 'Error: $e';
    }
  }
